            ...
            <div class="card">
                <div class="card-header">Dashboard</div>
                    <div class="card-body">
                        ...
                        <button type="button" class="btn btn-success" data-toggle="modal" data-target="#addcontributor" title="By specifying the primary email address, give another existing user access to this To Do List entry, along with it's subentries">Add Contributor</button>
